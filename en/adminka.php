...
<td style='width: 75%; height: 10px'><img src="images.jpg" alt="Logo Fujikura"><B><h2><?php echo $tr_oblik;?></h2></td>
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> 
   <?php echo $tr_nomer;?><input type="text"  name="nomer" maxlength="5" tabindex="1"> 
   <?php echo $tr_misce;?><input type="text" name="misce" maxlength="15" tabindex="2">  
   <?php echo $tr_cycle;?><input type="text" name="cycle" maxlength="9" tabindex="3">
   <input type="submit"  name="subBtn" tabindex="5" value="<?php echo $tr_add_apl;?>">
   <br>
